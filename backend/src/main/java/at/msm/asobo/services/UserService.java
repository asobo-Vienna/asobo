...
public class UserService {
    ...
    public User getUserById(UUID id) {
        return this.userRepository.findUserByIdAndIsDeletedFalse(id).orElseThrow(() -> new UserNotFoundException(id));
    }
    ...
    public UserPublicDTO getUserDTOById(UUID id) {
        User user = this.userRepository.findUserByIdAndIsDeletedFalse(id).orElseThrow(() -> new UserNotFoundException(id));
